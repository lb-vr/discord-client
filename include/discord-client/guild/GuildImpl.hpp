...
#include "Guild.hpp"
#include "../_impl/DiscordObjectBaseImpl.hpp"

#include "ContentFilterLevel.hpp"
#include "GuildFeature.hpp"
#include "MessageNotificationLevel.hpp"
#include "MfaLevel.hpp"
#include "PremiumTier.hpp"
#include "VerificationLevel.hpp"
#include "GuildEmbedBase.hpp"
#include "GuildMemberBase.hpp"

#include "../channel/ChannelBase.hpp"
#include "../channel/ChannelNameAndType.hpp"
#include "../role/RoleBase.hpp"
#include "../voice/VoiceRegionBase.hpp"
#include "../voice/VoiceRegionId.hpp"
#include "../voice/VoiceStateBase.hpp"
#include "../voice/VoiceStateWithoutGuild.hpp"
...
class Guild::__Impl {
public:
	using roles_d = array_d<_base<role::RoleBase>>;
	using emojis_d = array_d<_base<emoji::EmojiBase>>;
	using guild_features_d = array_d<_base<guild_feature_d>>;
	using voice_states_d = array_d<_base<voice::VoiceStateNoGuildId>>;
	using guild_members_d = array_d<_base<GuildMemberBase>>;
	using channels_d = array_d<_base<channel::ChannelBase>>;
	using presence_updates_d = array_d<_base<presence::PresenceUpdateBase>>;
	using voice_region_d = voice::VoiceRegionBase;
	...
	_base<voice_region_d>				region_;						///< voice region id for the guild.
